module ApplicationHelper
  #добавляем методы для фронтенда чтобы выдавать навигацию для паджинации
  include Pagy::Frontend

  #пагинация страниц, кнопки для перекключения
  def pagination(obj)
    #raw это метод для того чтобы выводить на экран не просто разметку как плейн текст, а обрабатывать ее правильным образом
